...
export default function Home() {
  ...
  return (
    <div className={styles.page}>
      ...
      <section className={styles.sectionBlue}>
        <div className={styles.contactModernWrapper}>
          <h1 className={styles.contactModernTitle}>Get In Touch</h1>
          <div className={styles.contactModernSubtitle}>Feel free to reach out via email or schedule a meeting through Calendly.</div>
          <div className={styles.contactModernButtons}>
            <a href="mailto:graham.a.pilkington@gmail.com" className={styles.contactModernButtonPrimary}>
              <span className={styles.contactModernButtonIcon}>→</span> Email Me Directly
            </a>
            <a href="https://calendly.com/graham-a-pilkington/30min" target="_blank" rel="noopener noreferrer" className={styles.contactModernButtonSecondary}>
              <span className={styles.contactModernButtonIcon}>📅</span> Book a Call on Calendly
            </a>
          </div>
          <div className={styles.contactFooter}>
            <span>© {new Date().getFullYear()} Graham Pilkington. All rights reserved.</span>
            <span className={styles.contactFooterLinks}>
              <a href="https://www.linkedin.com/in/graham-pilkington/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className={styles.contactFooterIcon}>
              ...
              <a href="https://github.com/GrahamPilk" target="_blank" rel="noopener noreferrer" aria-label="GitHub" className={styles.contactFooterIcon}>
